 ...
 **/
public class MsgReceiver extends SimpleBehaviour implements Consumer<ACLMessage> {
	 ...
	 */
//	protected void accept(ACLMessage msg) {
//	}
	...
	@Override
	public void accept(ACLMessage aclMessage) {
