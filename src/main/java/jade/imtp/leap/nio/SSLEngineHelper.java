...
public final class SSLEngineHelper implements BufferTransformer {
	...
	private void checkStatusAfterHandshakeTasks(HandshakeStatus handshakeStatus) throws SSLException, IOException {
	...
	/**
	 * generates handshake data and calls {@link NIOJICPConnection#writeToChannel(ByteBuffer) }, possibly
