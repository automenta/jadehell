...
public class NIOJICPConnection extends Connection {
	...
	/**
	 * Write a JICPPacket on the connection, first calls {@link #preprocessBufferToWrite(ByteBuffer) }.
	 * When the buffer returned by {@link #preprocessBufferToWrite(ByteBuffer) }, no write will be performed.
