...
public class PlatformEvent extends JADEEvent implements jade.wrapper.PlatformEvent {
	 ...
	 * @param The {@link AID AID} of the new or dead agent.
	 * @param eventSource The container id of the source of the event.
	 ...
	 * <p>
	 * @param The {@link AID AID} of the moved agent.
	...
	/**
	 * Returns the {@link ContainerID ContainerID} of the event source.
	 * <p>
	 ...
	 * <p>
	 * @return The {@link ContainerID ContainerID} of the event source.
	 * @see #getNewContainer()
	 */
	...
	/**
	 * Returns the {@link ContainerID ContainerID} of the container
	 ...
	 * <p>
	 * @return The {@link ContainerID ContainerID} of the container
	...
	/**
	 * Returns the {@link AID AID} of the agent that was born,
	 ...
	 * involved.
	 * <p>
	 * @return The {@link AID AID} of the agent that was born,
	 * died, or moved.
	 * @see #getContainer()
	 */
	public AID getAgent() {
