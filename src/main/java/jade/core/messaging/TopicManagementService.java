...
public class TopicManagementService extends BaseService {
	...
	// Utility methods
	///////////////////////////////////////////////////
	private void broadcastRegistration(AID aid, AID topic, Slice[] slices) throws ServiceException {
	...
	private void broadcastDeregistration(AID aid, AID topic, Slice[] slices) throws ServiceException {
		if (myLogger.isLoggable(Logger.CONFIG)) {
