...
public class TestAgentFrame extends JFrame {
  ...
  private void jbInit() throws Exception {
    ...
    fileMenu.setFont(new Font("Dialog", 0, 12));
    fileMenu.setMnemonic('F');
    fileMenu.setText("File");
    exitMenuItem.setBackground(Color.white);
    exitMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    amsRegMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    amsDeregMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    amsSearchMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    pingLausanneMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    dfSearchMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    dfRegMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    dfDeregMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    helpMenu.setFont(new Font("Dialog", 0, 12));
    helpMenu.setMnemonic('H');
    helpMenu.setText("Help");
    aboutMenuItem.setBackground(Color.white);
    aboutMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    openButton.setFont(new Font("Dialog", 0, 11));
    ...
    sendButton.setFont(new Font("Dialog", 0, 11));
    ...
    newButton.setFont(new Font("Dialog", 0, 11));
    ...
    saveButton.setFont(new Font("Dialog", 0, 11));
    ...
    saveMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    sendMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    templatesMenuItem.setFont(new Font("Dialog", 3, 12));
    templatesMenuItem.setText("Templates:");
    traceMenu.setBackground(Color.white);
    traceMenu.setFont(new Font("Dialog", 0, 12));
    ...
    claerQueueMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    currentMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    replyMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    deleteMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    statisticsMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    loadMsgMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    saveMsgMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    loadQMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    saveQMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    systemOutMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    currentToOutMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    behaviourMenu.setFont(new Font("Dialog", 0, 12));
    ...
    pingRadioButtonMenuItem.setFont(new Font("Dialog", 0, 12));
    ...
    localPingMenuItem.setFont(new Font("Dialog", 0, 12));
...
//    messagesMenu.addSeparator();
  ...
  private class AboutFrame extends JWindow {
    ...
    private void jbInit() throws Exception {
      ...
      contentPanel.setFont(new Font("Dialog", 0, 11));
