...
public class ACLTracePanel extends JPanel {
  ...
  public void addMessageNode(String direction, String theTime, ACLMessage theACL) {
    ...
    Properties prop = theACL.getAllUserDefinedParameters();
    if (prop.size() > 0) {
  ...
  private void jbInit() throws Exception {
    ...
    systemMenuItem.setFont(new Font("Dialog", 0, 11));
    ...
    zoomMenuItem.setFont(new Font("Dialog", 0, 11));
    ...
    saveMenuItem.setFont(new Font("Dialog", 0, 11));
    ...
    stasticsMenuItem.setFont(new Font("Dialog", 0, 11));
    ...
    aboutMenuItem.setFont(new Font("Dialog", 0, 11));
    ...
    deleteMenuItem.setFont(new Font("Dialog", 0, 11));
    ...
    ascRadioButton.setFont(new Font("Dialog", 0, 12));
    ...
    descRadioButton.setFont(new Font("Dialog", 0, 12));
    ...
    sortComboBox.setFont(new Font("Dialog", 0, 12));
    ...
    saveQMenuItem.setFont(new Font("Dialog", 0, 11));
    ...
    openQMenuItem.setFont(new Font("Dialog", 0, 11));
    ...
    clearQMenuItem.setFont(new Font("Dialog", 0, 11));
...
//  ***EOF***
  ...
  private class AboutFrame extends JWindow {
    ...
    private void jbInit() throws Exception {
      ...
      logoLabel3.setFont(new Font("SansSerif", 1, 60));
      ...
      jLabel4.setFont(new Font("Dialog", 1, 20));
