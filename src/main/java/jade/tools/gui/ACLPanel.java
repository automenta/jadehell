...
public class ACLPanel extends JPanel {
  ...
  private void jbInit() throws Exception {
    senderLabel.setFont(new Font("Dialog", 0, 11));
    senderLabel.setText("sender:");
    this.setBackground(Color.white);
    this.setOpaque(false);
    this.setLayout(gridBagLayout1);
    receiverLabel.setFont(new Font("Dialog", 0, 11));
    receiverLabel.setText("receivers:");
    replytoLabel.setFont(new Font("Dialog", 0, 11));
    replytoLabel.setText("reply-to");
    contentLabel.setFont(new Font("Dialog", 0, 11));
    contentLabel.setText("content");
    languageLabel.setFont(new Font("Dialog", 0, 11));
    languageLabel.setText("language");
    encodingLabel.setFont(new Font("Dialog", 0, 11));
    encodingLabel.setText("encoding");
    ontologyjLabel.setFont(new Font("Dialog", 0, 11));
    ontologyjLabel.setText("ontology");
    protocolLabel.setFont(new Font("Dialog", 0, 11));
    protocolLabel.setText("protocol");
    inreplytoLabel.setFont(new Font("Dialog", 0, 11));
    inreplytoLabel.setText("in-reply-to");
    replywithLabel.setFont(new Font("Dialog", 0, 11));
    replywithLabel.setText("reply-with");
    replybyLabel.setFont(new Font("Dialog", 0, 11));
    replybyLabel.setText("reply-by");
    userpropLabel.setFont(new Font("Dialog", 0, 11));
    userpropLabel.setText("User-prop.");
    protocolComboBox.setBackground(Color.white);
    protocolComboBox.setFont(new Font("Dialog", 0, 11));
    replytoList.setFont(new Font("Dialog", 0, 11));
    convidLabel.setFont(new Font("Dialog", 0, 11));
    convidLabel.setText("conv.-id");
    userpropList.setFont(new Font("Dialog", 0, 11));

    performativeLabel.setFont(new Font("Dialog", 0, 11));
    performativeLabel.setText("performative");
    senderButton.setBackground(Color.white);
    senderButton.setFont(new Font("Dialog", 0, 12));
    ...
    replyByButton.setFont(new Font("Dialog", 0, 12));
    ...
    senderTextField.setFont(new Font("Dialog", 0, 11));
    ...
    replybyTextField.setFont(new Font("Dialog", 0, 11));
    ...
    theTabbedPane.setFont(new Font("Dialog", 0, 12));
    ...
    toLabel.setFont(new Font("Dialog", 0, 11));
    toLabel.setText("to");
    fromLabel.setFont(new Font("Dialog", 0, 11));
    fromLabel.setText("from");
    commentsLabel.setFont(new Font("Dialog", 0, 11));
    commentsLabel.setText("comments");
    aclRepreLabel.setFont(new Font("Dialog", 0, 11));
    aclRepreLabel.setToolTipText("ACL Repr");
    aclRepreLabel.setText("acl repr.");
    payLoadLabel.setFont(new Font("Dialog", 0, 11));
    payLoadLabel.setToolTipText("Payload Length");
    payLoadLabel.setText("payload len.");
    envDateLabel.setFont(new Font("Dialog", 0, 11));
    envDateLabel.setToolTipText("Date");
    envDateLabel.setText("date");
    intReceiversLabel.setFont(new Font("Dialog", 0, 11));
    ...
    envDateTextField.setFont(new Font("Dialog", 0, 11));
    ...
    defaultEnvelopeButton.setFont(new Font("Dialog", 0, 12));
    ...
    fromButton.setFont(new Font("Dialog", 0, 12));
    fromButton.setBackground(Color.white);
    envFromTextField.setFont(new Font("Dialog", 0, 11));
    ...
    envDateButton.setFont(new Font("Dialog", 0, 12));
    ...
    contentTextArea.setFont(new Font("Dialog", 0, 11));
