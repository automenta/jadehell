...
public class AIDAddressList extends JPanel {
  ...
  private void jbInit() throws Exception {
    ...
    viewButton.setFont(new Font("Dialog", 0, 11));
    ...
    addButton.setFont(new Font("Dialog", 0, 11));
    ...
    deleteButton.setFont(new Font("Dialog", 0, 11));
    ...
    contentList.setFont(new Font("Dialog", 0, 11));
  ...
  private class AIDAddressDialog extends JDialog {
    ...
    void jbInit() throws Exception {
      ...
      theAddressField.setFont(new Font("Dialog", 0, 11));
